...
class TextBufferTest
    ...
    // Ce test s'assure que la fonction resetWithCopy() fonctionne bien. Le
    // comportement attendu devrait configurer et modifie adéquatement le
    // TextBuffer. Ici on test la longueur supérieure à la longueur restante de la
    // chaîne.
    ...
    void testResetWithCopy() throws IOException {
        ...
        assertEquals(expected, result, "The TextBuffer should handle cases where length exceeds remaining characters.");
    }
